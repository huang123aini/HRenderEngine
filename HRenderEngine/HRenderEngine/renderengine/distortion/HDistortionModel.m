...
@implementation HDistortionModel
...
- (void)setupBufferData
{
    ...
    {
        case HDistortionModelTypeLeft:
            break;
        case HDistortionModelTypeRight:
    ...
    self.indexCount = 3158;
    GLshort indexData[self.indexCount];
    ...
    self.vertexBuffer = bufferIDs[0];
    self.indexBuffer = bufferIDs[1];
